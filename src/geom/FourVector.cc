...
#include "geom/FourVector.hh"
#include "geom/ThreeVector.hh"
#include "spdlog/spdlog.h"

using NuGeom::FourVector;
using NuGeom::ThreeVector;
...
NuGeom::FourVector::RotMat FourVector::Align(const ThreeVector &axis) const noexcept {
...
NuGeom::FourVector::RotMat FourVector::AlignZ() const noexcept {
    ThreeVector z{0, 0, 1};
    return Align(z);
}
