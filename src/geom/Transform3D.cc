...
Transform3D::Transform3D(double xx, double xy, double xz, double tx, double yx, double yy,
                         double yz, double ty, double zx, double zy, double zz, double tz) {
...
Transform3D Transform3D::operator*(const Transform3D &other) const {
    return {m_mat[0] * other.m_mat[0] + m_mat[1] * other.m_mat[4] + m_mat[2] * other.m_mat[8],
            ...
            m_mat[0] * other.m_mat[3] + m_mat[1] * other.m_mat[7] + m_mat[2] * other.m_mat[11] +
                m_mat[3],
            ...
            m_mat[4] * other.m_mat[3] + m_mat[5] * other.m_mat[7] + m_mat[6] * other.m_mat[11] +
                m_mat[7],
            ...
            m_mat[8] * other.m_mat[3] + m_mat[9] * other.m_mat[7] + m_mat[10] * other.m_mat[11] +
                m_mat[11]};
}
...
Rotation3D::Rotation3D(const Vector3D &vec, double angle) : Transform3D() {
    ...
    std::array<double, 12> mat = {cosa + axis.X() * axis.X() * (1 - cosa),
                                  axis.X() * axis.Y() * (1 - cosa) - axis.Z() * sina,
